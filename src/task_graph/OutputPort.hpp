#ifndef GRAPH_ANALYSIS_TASK_GRAPH_OUTPUTPORT_HPP
#define GRAPH_ANALYSIS_TASK_GRAPH_OUTPUTPORT_HPP
...
public:
     ...
     * \return class type
     */
    static std::string vertexType() { return "graph_analysis::task_graph::OutputPort"; }
