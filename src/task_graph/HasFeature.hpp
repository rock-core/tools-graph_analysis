...
public:
    ...
    HasFeature(const Vertex::Ptr& parent, const Vertex::Ptr& child,
               const std::string& label)
        : Edge(parent, child, label)
    {
        // TODO: Check that parent has no other child of the same type AND the
        // same label
    }
    ...
    {
        return "graph_analysis::task_graph::HasFeature";
    }
...
protected:
     ...
     */
    virtual HasFeature* getClone() const
    {
        return new HasFeature(*this);
    }
};
}
}
