...
public:
    ...
    HasUniqueFeature(const Vertex::Ptr& parent, const Vertex::Ptr& child,
    ...
    {
        return "graph_analysis::task_graph::HasUniqueFeature";
    }
...
protected:
     ...
     */
    virtual HasUniqueFeature* getClone() const
    {
        return new HasUniqueFeature(*this);
    }
};
}
}
